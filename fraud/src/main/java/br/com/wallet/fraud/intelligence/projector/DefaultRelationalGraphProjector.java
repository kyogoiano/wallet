...
@Service
public class DefaultRelationalGraphProjector implements RelationalGraphProjector {

    private static final Logger log = LoggerFactory.getLogger(DefaultRelationalGraphProjector.class);
    ...
    public DefaultRelationalGraphProjector(
